...
<div class="row">
	<div class="col-md-12">
			...
			foreach($delivered as $row){
				...
				if($row->INVOICE_ID != NULL){
					...
					if($row->DAYS_OVERDUE > 0){
						$total_past_due += $row->BALANCE;
					}
					else{
						$total_current += $row->BALANCE;
					}
					
					if($row->DAYS_OVERDUE > 0 AND $row->DAYS_OVERDUE <= 15){
		...
		<a id="back-to-top" href="#" class="btn btn-success btn-lg" role="button"><i class="fa fa-chevron-up"></i></a>
	</div>
</div>
