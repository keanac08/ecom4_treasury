		...
		<div class="col-md-12">
			<div class="box box-danger">
				<div class="box-body">
						...
						<div class="row">
							<div class="col-lg-9">
							<p class="lead well well-sm"><small>Check Details <span style="font-size: 80%;" class="text-danger;"><i>(Please complete the fields below)</i></span></small> </p>
						...
						$.ajax({
							...
							success:function(data){
								...
								//~ window.location.replace("");
								 swal({
									text: "Check details has been successfully saved!", 
									type: "success",
									confirmButtonColor: '#DD6B55'
								}).then(function() {
									//~ window.open('<?php echo base_url();?>receivables/check_warehousing/pdc_details_pdf/'+data, '_blank');
									//~ location.reload();
									location.href = '<?php echo base_url();?>receivables/check_warehousing/customer_check_list';
								});
							}
						});
					}
