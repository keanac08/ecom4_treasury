					...
					<table class="table table-striped table-bordered table-hover" id="myTable">
						...
						?>
							<tr>
								...
								<td><?php echo short_date($row->DATE_APPROVED); ?></td>
								<td><?php echo $row->DATE_DEPOSIT != NULL ? short_date($row->DATE_DEPOSIT):'<a href="#" data-toggle="modal" data-target="#myModal2" data-check_id="'.$row->CHECK_ID.'" class="text-info modal-edit"><i class="fa fa-edit"></i></a>';?></td>
