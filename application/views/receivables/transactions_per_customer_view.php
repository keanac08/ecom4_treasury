	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body" style="font-size: 16px;">
				...
				<hr />
				<p class="text-justify">To ensure that your Statement of Account is updated, always send the corresponding Creditable Withholding Tax Certificate (CWT) copy via email right after making the payment online or via bank deposit. Send this always to IPC Treasury together with the validated deposit slip or proof of online transfer/payment. In case the dealer decide to send the check payment over to IPC Treasury, the same documents should be attached( payment details of the check and Original CWT for the payment). The same is true when sending Post Dated Checks to IPC Treasury for Vehicle Fleet Transactions or Retail Vehicle Transactions with payment terms.</p>
