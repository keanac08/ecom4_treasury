			...
			<div class="box box-danger">
				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
							<?php 
							if($this->session->flashdata('save_success') != NULL){
							?>
							<div class="alert alert-success alert-dismissible">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								<i class="icon fa fa-check"></i> <?php echo $this->session->flashdata('save_success'); ?>
							</div>
							<?php 
							}
							?>
	...
	$(document).ready(function() {
		...
		$('button#btn-search').click(function(){
			...
			$.ajax({
				...
				url: '<?php echo base_url();?>receivables/check_warehousing/ajax_new_search_cs_number',
