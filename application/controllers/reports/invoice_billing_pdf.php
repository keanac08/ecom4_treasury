...
class Invoice_billing_pdf extends CI_Controller {
	...
	public function index(){
		...
		$html = '<table border="0" style="padding: 1px 2px;font-size: 11px;">
					<tr>
						<td colspan="5" align="right" style="font-size: 14px;"><strong>SYSTEM COPY BILLING STATEMENT</strong></td>
					</tr>
					<tr>
						<td colspan="5" align="right" style="font-size: 14px;"><span style="font-size: 12px;">Original Billing Statement No.</span><strong> '.$header->TRX_NUMBER.' </strong></td>
					</tr>
					<tr>
						<td colspan="5">&nbsp;</td>
					</tr>
		...
		foreach($lines as $line){
			$data .= '<tr>
						<td width="60px" align="center" style="borders-right:1px solid #000;">'.$ctr.'</td>
						<td width="416px" style="borders-right:1px solid #000;">'.$line->DESCRIPTION.'</td>
						...
						<td colspan="2">
							<table border="1" style="padding:3px;">
								<tr style="font-weight: bold;">
									...
									<td width="416px" align="center">BILLING DETAILS</td>
